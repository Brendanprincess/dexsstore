...
<b>Order Form Submitted: Token Advertising</b>
-------------------------
<b>Chain:</b> ${chain}
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <Input
                ...
                onBlur={() => {
                  if (tokenAddress) {
                    sendTelegramNotification(`<b>User Action:</b> Input Token Address: <code>${tokenAddress}</code>`);
                  }
                }}
                placeholder=""
                ...
                {AD_PACKAGES.map((p) => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      sendTelegramNotification(`<b>User Action:</b> Selected package <b>${p.label}</b> ($${p.price})`);
                    }}
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  onBlur={() => {
                    if (title) {
                      sendTelegramNotification(`<b>User Action:</b> Input Title: "${title}"`);
                    }
                  }}
                  placeholder=""
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  onBlur={() => {
                    if (pitch) {
                      sendTelegramNotification(`<b>User Action:</b> Input Pitch: "${pitch}"`);
                    }
                  }}
                  placeholder=""
                  className="bg-secondary border-border text-foreground pr-16"
            ...
            <div>
              ...
              <ImageUpload onFileSelect={(file) => {
                console.log("Ad image:", file.name);
                sendTelegramNotification(`<b>User Action:</b> Uploaded image: <code>${file.name}</code>`);
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-3 cursor-pointer">
                <input type="checkbox" checked={check1} onChange={(e) => {
                  ...
                  sendTelegramNotification(`<b>User Action:</b> ${e.target.checked ? "Checked" : "Unchecked"} Agreement 1`);
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input type="checkbox" checked={check2} onChange={(e) => {
                  ...
                  sendTelegramNotification(`<b>User Action:</b> ${e.target.checked ? "Checked" : "Unchecked"} Agreement 2`);
                }} className="mt-1 accent-primary" />
                <span className="text-sm text-foreground font-medium">
